...
if(isset($_REQUEST['send']))
  ...
  $c=$_REQUEST['by'];
	...
	if(mysql_query("UPDATE feedback                                                              
SET srno='$a',user_name='$b',comment='$c'
WHERE srno='$itemno'"))
{ 
header("location:cpanel.php?itemno=8");
}
else
{
	die(mysql_error());
...
<?php
	$sql=mysql_query("select * from feedback where srno='$itemno'");
	if($sql==false)
	{
		die(mysql_error());
	}
