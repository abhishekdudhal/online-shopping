...
<li class="list-group-item"><a href="nprod.php">Production</a></li>
 ...
 require "connect.php";
    ...
    echo"<form method='post'><table border='0' align='center'><tr>";
	   ...
	   if($stk!=0)
	   {   
       echo"<br><br><a href='loginshop.php?itemno=$i'><img src='images/MetalPlakDa5new.gif' width='70' height='20'/></a>
       <a href='logincart.php?itemno=$i'><img src='images/addtocart.gif' width='70' height='20'/></a>";
	   }
	   else
		  echo" <br><br><img src='images/outofstock.png' width='100' height='70'/>";
      echo"</td>";
      $n++;
        }
		}
