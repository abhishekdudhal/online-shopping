...
{   $fname = strip_tags($_POST['txt_fname']);
 ...
 mail("$mail","PASSWOED CHANGE EB BOOK",$msg);
...
<div class="signin-form">
	 ...
	 <div class="signin-form">
        <form method="post" class="form-signin">
            <h2 class="form-signin-heading" align="center">Sign up.</h2><hr>
            <?php
			if(isset($error))
			{
            ...
            <input type="text" class="form-control" name="txt_mname" placeholder="Mobile Number" value="<?php if(isset($error)){echo $mname;}?>" />
			  ...
			  <hr>
            <div class="form-group">
            	<button type="submit" class="btn btn-primary" name="btn-signup" align="center">
