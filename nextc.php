...
<li class="list-group-item"><a href="nit.php">Info Tech</li>
<li class="list-group-item"><a  href="ncs.php">Computer</li>
<li class="list-group-item"><a  href="nmech.php">Mechan</a>ical</li>
...
<li class="list-group-item"><a href="nprod.php">Production</a></li>
 ...
 <div class="ascroll">
    ...
    <?php
 require "connect.php";
	$sql="select * from nbook where Branch='EXTC'";
    $row = $conn->query($sql);
    $n=0;
