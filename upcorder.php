...
<?php
 ...
 <?php
	$sql=mysql_query("select * from orders where order_no='$itemno'");
	if($sql==false)
	{
		die(mysql_error());
	}
    ...
    <div class="main-content">
        ...
        <form method="post" name="f1" onSubmit="return vali()" class="form-basic" action="#">
            ...
            <div class="form-row">
                <label>
                    <span>User Name:</span>
                    <input name="bi" type="text" id="bi" required="required" onChange="return phone()"  readonly="readonly"value="<?php echo $a;?>">
                </label>
            </div>
			...
			<div class="form-row">
                <label>
                    <span>Mobile no:</span>
                    <input name="by" type="text" id="by" required="required" value="<?php echo $b;?>"  readonly="readonly"onChange="return phone()">
                </label>
            </div>
			 ...
			 <div class="form-row">
                <label>
                    <span>Address</span>
					<input name="bb" type="text" id="bb" required="required" value="<?php echo $br;?>" readonly="readonly" onChange="return phone()">
                    </label>
            </div>
			 ...
			 <div class="form-row">
                <label>
                    ...
                    <input name="bb" type="text" id="bb" required="required" value="<?php echo $p;?>"  readonly="readonly"onChange="return phone()">
                </label>
            </div>
			...
			<div class="form-row">
                <label>
                    <span>Order no:</span>
					<input name="ap" type="text" id="ap" required="required" value="<?php echo $itemno;?>" readonly="readonly" onChange="return phone()">
			...
			<div class="form-row">
                <label>
                    <span>PayToken:</span>
					<input name="bp" type="text" id="bp" required="required" value="<?php echo $aut;?>" readonly="readonly" onChange="return phone()">
                </label>
            </div>
           ...
           <div class="form-row">
                <label>
                    <span>City:</span>
					<input name="bd" type="text" id="bd" required="required" value="<?php echo $stck;?>" readonly="readonly" onChange="return phone()">
                </label>
            </div>
			 ...
			 <div class="form-row">
                <label>
                    <span>Courier:</span>
					<input name="bs" type="text" id="bs" required="required" value="<?php echo $sold;?>" readonly="readonly" onChange="return phone()">
					</label>
            </div>
			 ...
			 <div class="form-row">
                <label>
                    <span>BookId:</span>
			<input name="bq" type="text" id="bq" required="required" value="<?php echo $sem;?>" readonly="readonly" onChange="return phone()">
			</label>
            </div>
