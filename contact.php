...
if(isset($_REQUEST['send']))
  ...
  $e=$_REQUEST['a'];
 $f=$_REQUEST['comments'];
	 if( mysql_query("INSERT INTO contactus (name, emailid,mobileno,purpose,discription)
		VALUES ('$b' ,'$c','$d','$e','$f')"))
		{
  ...
  <div class="row">
    <div class="col-sm-5">
      ...
      <p><font color="black" size="3px"><span class="glyphicon glyphicon-phone"></span></span> +91-7768000788</font></p>
	   <p><font color="black" size="3px"><span class="glyphicon glyphicon-phone"></span></span> +91-9011902243</font></p>
