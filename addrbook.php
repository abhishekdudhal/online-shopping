 ...
 $file=$_FILES['photo']['tmp_name'];
   ...
   if($file)
   {
    ...
    $image_size=getimagesize($_FILES['photo']['tmp_name']);
	 if( mysql_query("INSERT INTO rbook (BOOKNAME, Year,Branch,Sem,Author,PublicatonHouse,BookImage,Rent,stock)
		VALUES ('$b','$c','$d','$e','$f','$g','$image','$i','$j')"))
		{
    ...
    <div class="main-content">
        ...
        <form method="post" enctype="multipart/form-data" name="f1" onSubmit="return vali()" class="form-basic" action="#">
            ...
            <div class="form-row">
                <label>
                    <span>Book Name:</span>
           <input name="bn" type="text" id="bn" required="required" onChange="return phone()"></label>
		   </div>
